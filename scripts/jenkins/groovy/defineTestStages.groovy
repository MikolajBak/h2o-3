def call(final pipelineContext) {
  ...
  def NIGHTLY_REPEATED_STAGES = [
    ...
    [
      stageName: 'Java 16 JUnit', target: 'test-junit-1x-jenkins', pythonVersion: '2.7', javaVersion: 16,
      timeoutValue: 180, component: pipelineContext.getBuildConfig().COMPONENT_JAVA, 
      additionalTestPackages: [pipelineContext.getBuildConfig().COMPONENT_PY],
      imageSpecifier: "python-2.7-jdk-16"
    ],
    [
      stageName: 'Java 17 JUnit', target: 'test-junit-1x-jenkins', pythonVersion: '2.7', javaVersion: 17,
      timeoutValue: 180, component: pipelineContext.getBuildConfig().COMPONENT_JAVA,
      additionalTestPackages: [pipelineContext.getBuildConfig().COMPONENT_PY],
  ...
  def NIGHTLY_STAGES = [
    ...
    [
      stageName: 'Java 16 Smoke', target: 'test-junit-smoke-jenkins', javaVersion: 16, timeoutValue: 20,
      component: pipelineContext.getBuildConfig().COMPONENT_JAVA
    ],
    [
      stageName: 'Java 17 Smoke', target: 'test-junit-smoke-jenkins', javaVersion: 17, timeoutValue: 20,
      component: pipelineContext.getBuildConfig().COMPONENT_JAVA
    ],
    [
